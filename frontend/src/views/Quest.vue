      ...
      return {
        quests: [
          ...
          },
          {
            ...
            password: 'Vanya',
            icon: 'extension',
            title: 'El enigma de las 5 casas',
            media: 'einstein.jpg',
          ...
          },
          {
            ...
            media: 'python.gif',
            description: 'Esta es sin duda mi escena preferida de la película. Iba a poner algo relacionado con preguntarte tu color favorito y responder mal a la pregunta, pero esta otra me parece más divertida y un poco más difícil de sacar.',
            tags: ['respuesta'],
            favorite: false,
            timestamp: 0
          },
